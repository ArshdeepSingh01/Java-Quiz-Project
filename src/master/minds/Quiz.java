...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        setBounds(230,100,1150,700);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("master/minds/icons/quiz.jpg"));
        JLabel l1 = new JLabel(i1);
        l1.setBounds(0,0,1150,200);
        add(l1);
        
        JLabel l2 = new JLabel("Master Minds!");
        l2.setForeground(Color.white);
        l2.setFont(new Font("Aquate Script PERSONAL USE ONLY",Font.BOLD,60));
        l2.setBounds(80,70,700,65);
        l1.add(l2);
        
        qno = new JLabel("");
        qno.setFont(new Font("Arimo",Font.BOLD,20));
        qno.setBounds(120,250,40,25);
        add(qno);
        
        question = new JLabel("");
        question.setFont(new Font("Arimo",Font.BOLD,20));
        question.setBounds(170,250,600,25);
        add(question);
        ...
        opt1.setBounds(170,300,600,40);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Arimo",Font.PLAIN,18));
        add(opt1);
        
        opt2 = new JRadioButton("");
        opt2.setBounds(170,350,600,40);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Arimo",Font.PLAIN,18));
        add(opt2);
        
        opt3 = new JRadioButton("");
        opt3.setBounds(170,400,600,40);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Arimo",Font.PLAIN,18));
        add(opt3);
        
        opt4 = new JRadioButton("");
        opt4.setBounds(170,450,600,40);
        opt4.setBackground(Color.WHITE);
        opt4.setFont(new Font("Arimo",Font.PLAIN,18));
        add(opt4);
        ...
        next.setFont(new Font("Arimo",Font.PLAIN,18));
        next.setForeground(Color.WHITE);
        next.setBackground(new Color(30,144,254));
        next.setBounds(850,350,150,40);
        next.addActionListener(this);
        add(next);
        
        lifeline = new JButton("50-50 LifeLine");
        lifeline.setFont(new Font("Arimo",Font.PLAIN,18));
        lifeline.setForeground(Color.WHITE);
        lifeline.setBackground(new Color(30,144,254));
        lifeline.setBounds(850,430,150,40);
        lifeline.addActionListener(this);
        add(lifeline);
        
        submit = new JButton("Submit");
        submit.setFont(new Font("Arimo",Font.PLAIN,18));
        submit.setForeground(Color.WHITE);
        submit.setEnabled(false);
        submit.setBackground(new Color(30,144,254));
        submit.setBounds(850,510,150,40);
    ...
    public void paint(Graphics g){
        ...
        g.setFont(new Font("Arimo",Font.BOLD,20));
        
        if(timer>0){
            g.drawString(time,860,300);
        }else{
            g.drawString("Times up!!", 860, 300);
        }
        timer--;
        try{
            Thread.sleep(1000);
